...
class AppThemes {
  ...
  //Text Colors
  static const Color _lightTextColor = Color.fromRGBO(0, 0, 0, 0.7);
  // static const Color _lightAlertTextColor = Colors.black;
  // static const Color _lightTextSecondaryColor = Colors.black;

  //Border Color
  static const Color _lightBorderColor = Color(0xff757575);
  ...
  static final TextTheme _lightTextTheme = TextTheme(
    headline1: TextStyle(
        fontSize: 28.0, color: Color(0xff3F414E), fontWeight: FontWeight.bold),
    ...
    subtitle1: TextStyle(
        fontSize: 16.0, color: _lightTextColor, fontWeight: FontWeight.w500),
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    appBarTheme: AppBarTheme(
      ...
      textTheme: GoogleFonts.robotoTextTheme(_lightTextTheme),
    ),
